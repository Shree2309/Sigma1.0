...
import com.shree.sigma.watchlist.MCXModel;
...
public class MCXRepository {
    private RequestQueue requestQueue;
    private MutableLiveData<List<MCXModel>> mDataList;
    private static final String TAG = "ApiRepository";
    private Application application;

    public MCXRepository(Application application) {
            ...
            public void onResponse(JSONArray response) {
                    ...
                    try {
                        ...
                        for(int i=0;i<response.length();i++) {
                            ...
                            mList.add(new MCXModel(symbol,date,pChange,dayHigh,dayLow));
